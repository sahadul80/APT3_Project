        ...
        <div className="hero max-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <div className="text-center lg:text-right">
                    ...
                    <p className="py-2">REGISTER <Link href="/signup/" className="text-red-800">HERE</Link>!</p>
                </div>
                <div className="card shrink-0 w-full min-w-sm shadow-2xl bg-base-100">
                    <form className="card-body" onSubmit={handleSubmit}>
                        ...
                        <div className="form-control">
                            ...
                            <input type="password" name="password" placeholder="password" className="input input-bordered" value={formData.password} onChange={handleChange} required />
                            <label className="label">
