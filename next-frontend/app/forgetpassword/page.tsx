...
export default function ForgetPasswordForm() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            const response = await axios.get('http://localhost:5000/student/forgetpass/' + formData.email);
        ...
        <div className="hero max-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <div className="text-center lg:text-right">
                    ...
                    <p>REGISTER <Link href="/signup/" className="text-red-800">HERE</Link>!</p>
                    <p>To LogIn Click <Link href="/login/" className="text-red-800">HERE</Link>!</p>
                </div>
